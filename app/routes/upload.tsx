...
const Upload = () => {
    ...
    const handleFileAnalyze = async ({ companyName, jobTitle, jobDescription, file }: {companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        handleFileAnalyze({ companyName, jobTitle, jobDescription, file});
    }
